...
Рeзультаты тестов для программы с рефакторингом (папка RefactoredProgramm) и без (папка DefaultProgram) можно посмотреть в папке tests.
# Рефакторинг кода.
...
Все изменение привели к уменьшения времени работы программы примерно в 1.4 раза
